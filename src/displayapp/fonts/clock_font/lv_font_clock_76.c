...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 0, .adv_w = 557, .box_w = 31, .box_h = 10, .ofs_x = 2, .ofs_y = 24},
    {.bitmap_index = 78, .adv_w = 557, .box_w = 31, .box_h = 57, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 520, .adv_w = 557, .box_w = 31, .box_h = 59, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 978, .adv_w = 557, .box_w = 17, .box_h = 57, .ofs_x = 9, .ofs_y = 0},
    {.bitmap_index = 1221, .adv_w = 557, .box_w = 31, .box_h = 58, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 1671, .adv_w = 557, .box_w = 31, .box_h = 58, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 2121, .adv_w = 557, .box_w = 31, .box_h = 57, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 2563, .adv_w = 557, .box_w = 31, .box_h = 58, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 3013, .adv_w = 557, .box_w = 31, .box_h = 58, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 3463, .adv_w = 557, .box_w = 31, .box_h = 57, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 3905, .adv_w = 557, .box_w = 31, .box_h = 58, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 4355, .adv_w = 557, .box_w = 31, .box_h = 59, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 4813, .adv_w = 226, .box_w = 10, .box_h = 25, .ofs_x = 2, .ofs_y = 16}
};
