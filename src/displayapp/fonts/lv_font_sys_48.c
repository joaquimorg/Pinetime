...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 3243, .adv_w = 768, .box_w = 46, .box_h = 44, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 3749, .adv_w = 768, .box_w = 36, .box_h = 37, .ofs_x = 6, .ofs_y = 2},
    {.bitmap_index = 4082, .adv_w = 768, .box_w = 35, .box_h = 40, .ofs_x = 7, .ofs_y = 0},
    {.bitmap_index = 4432, .adv_w = 768, .box_w = 40, .box_h = 40, .ofs_x = 4, .ofs_y = 0},
    {.bitmap_index = 4832, .adv_w = 768, .box_w = 34, .box_h = 44, .ofs_x = 7, .ofs_y = -4},
    {.bitmap_index = 5206, .adv_w = 768, .box_w = 41, .box_h = 41, .ofs_x = 2, .ofs_y = -2},
    {.bitmap_index = 5627, .adv_w = 768, .box_w = 40, .box_h = 22, .ofs_x = 4, .ofs_y = 9},
    {.bitmap_index = 5847, .adv_w = 768, .box_w = 40, .box_h = 22, .ofs_x = 4, .ofs_y = 9},
    {.bitmap_index = 6067, .adv_w = 768, .box_w = 36, .box_h = 37, .ofs_x = 6, .ofs_y = 2},
    {.bitmap_index = 6400, .adv_w = 768, .box_w = 36, .box_h = 37, .ofs_x = 6, .ofs_y = 2}
};
