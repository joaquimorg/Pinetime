...
#define COLOR_SCR_TEXT   (IS_LIGHT ? lv_color_hex(0x3b3e42) : lv_color_hex(0xffffff))

/*BUTTON*/
#define COLOR_BTN           (IS_LIGHT ? lv_color_hex(0xffffff) : lv_color_hex(0x2F3540))
...
#define COLOR_BTN_CHK       lv_color_hex(0x00ffff) //(theme.color_primary)
#define COLOR_BTN_CHK_PR    lv_color_hex(0x00ffff)//(lv_color_darken(theme.color_primary, LV_OPA_30))
...
#define COLOR_BG_PR         (IS_LIGHT ? lv_color_hex(0xeeeeee) : lv_color_hex(0x111111))
...
static void basic_init(void)
{
    ...
    lv_style_set_pad_right(&styles->btn, LV_STATE_DEFAULT, LV_DPX(20));
    lv_style_set_pad_top(&styles->btn, LV_STATE_DEFAULT, LV_DPX(20));
    lv_style_set_pad_bottom(&styles->btn, LV_STATE_DEFAULT, LV_DPX(20));
...
static void checkbox_init(void)
{
    ...
    //lv_style_set_pattern_image(&styles->cb_bullet, LV_STATE_CHECKED, LV_SYMBOL_OK);//\xE2\x80\xA0
...
static void table_init(void)
{
    ...
    lv_style_set_border_color(&styles->table_cell, LV_STATE_DEFAULT, lv_color_hex(0x111111));
    lv_style_set_border_width(&styles->table_cell, LV_STATE_DEFAULT, 1);
    lv_style_set_border_side(&styles->table_cell, LV_STATE_DEFAULT, LV_BORDER_SIDE_TOP); //LV_BORDER_SIDE_TOP | 
    lv_style_set_pad_left(&styles->table_cell, LV_STATE_DEFAULT, LV_DPX(0));
    lv_style_set_pad_right(&styles->table_cell, LV_STATE_DEFAULT, LV_DPX(0));
    lv_style_set_pad_top(&styles->table_cell, LV_STATE_DEFAULT, LV_DPX(2));
    lv_style_set_pad_bottom(&styles->table_cell, LV_STATE_DEFAULT, LV_DPX(2));
