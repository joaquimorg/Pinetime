...
Steps::Steps(Pinetime::Applications::DisplayApp *app, Pinetime::Drivers::BMA421& stepCounter) : Screen(app), stepCounter{stepCounter} {
  ...
  lv_label_set_recolor(lSteps, true);                      /*Enable re-coloring by commands in the text*/
  ...
  lv_label_set_recolor(lActivity, true);                      /*Enable re-coloring by commands in the text*/
  ...
  lv_label_set_recolor(lTapStatus, true);                      /*Enable re-coloring by commands in the text*/
  ...
  lv_label_set_recolor(lTemp, true);                      /*Enable re-coloring by commands in the text*/
