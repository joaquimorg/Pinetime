...
WatchFaceMinimal::WatchFaceMinimal(Pinetime::Applications::DisplayApp *app,
  ...
  lv_style_copy(&hour_style, LabelStyle90);
  hour_style.text.color = lv_color_hex(0xFF0000);  
  ...
  lv_label_set_style(label_time_min, LV_LABEL_STYLE_MAIN, LabelStyle90);
  ...
  // :  
  lv_style_copy(&sep_style, LabelStyle90);
