...
void St7789::Init() {
  ...
  // Todo (joaquimorg) : validate the init sequence
  /*
  static const uint8_t RGBCTRL_PARA[] = { 0x01, 0x2C, 0x2D };
  WriteCommandData(ST7789_RGBCTRL, RGBCTRL_PARA, sizeof(RGBCTRL_PARA));

  static const uint8_t PORCTRL_PARA[] = { 0x01, 0x2C, 0x2D };
  WriteCommandData(ST7789_PORCTRL, PORCTRL_PARA, sizeof(PORCTRL_PARA));

  static const uint8_t FRCTRL1_PARA[] = { 0x01, 0x2C, 0x2D, 0x01, 0x2C, 0x2D };
  WriteCommandData(ST7789_FRCTRL1, FRCTRL1_PARA, sizeof(FRCTRL1_PARA));

  static const uint8_t INVCTRL_PARA[] = { 0x07 };
  WriteCommandData(ST7789_INVCTRL, INVCTRL_PARA, sizeof(INVCTRL_PARA));

  static const uint8_t LCMCTRL_PARA[] = { 0xA2, 0x02, 0x84 };
  WriteCommandData(ST7789_LCMCTRL, LCMCTRL_PARA, sizeof(LCMCTRL_PARA));

  static const uint8_t IDSET_PARA[] = { 0xC5 };
  WriteCommandData(ST7789_IDSET, IDSET_PARA, sizeof(IDSET_PARA));
  
  static const uint8_t VDVVRHEN_PARA[] = { 0x0A, 0x00 };
  WriteCommandData(ST7789_VDVVRHEN, VDVVRHEN_PARA, sizeof(VDVVRHEN_PARA));
  
  static const uint8_t VRHS_PARA[] = { 0x8A, 0x2A };
  WriteCommandData(ST7789_VRHS, VRHS_PARA, sizeof(VRHS_PARA));
  
  static const uint8_t VDVSET_PARA[] = { 0x8A, 0xEE };
  WriteCommandData(ST7789_VDVSET, VDVSET_PARA, sizeof(VDVSET_PARA));
  
  static const uint8_t VCMOFSET_PARA[] = { 0x0E };
  WriteCommandData(ST7789_VCMOFSET, VCMOFSET_PARA, sizeof(VCMOFSET_PARA));
  */
  //
...
void St7789::WriteCommandData(uint8_t command, const uint8_t *params, uint16_t len) {
